...
/* TODO: perhaps update this file as an alternative copy of obj-aout.h 
 Many obsolete things. The file is after all ~20 years old */

#define OBJ_PLAN9 1
#define OUTPUT_FLAVOR bfd_target_plan9_flavour
...
/* copied from old aout_gnu.h - better solution? */
struct exec
{
...
/* end of copy from old aout_gnu.h */
...
/* These old macros have been replaced in all other targets. Type conflict between symbolS and nlist */
...
struct fix;
void tc_plan9_fix_to_chars (char *where, struct fix *fixP, relax_addressT segment_address);
