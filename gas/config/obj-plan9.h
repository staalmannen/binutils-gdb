...
#define obj_frob_symbol(S,PUNT)	obj_plan9_frob_symbol (S, &PUNT)
#define obj_frob_file_before_fix() obj_plan9_frob_file_before_fix ()

extern void obj_plan9_frob_symbol (symbolS *, int *);
extern void obj_plan9_frob_file_before_fix (void);
